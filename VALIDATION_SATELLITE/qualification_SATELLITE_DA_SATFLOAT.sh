...
#inputs 
RUN=DA_SATFLOAT/
MODELDIR=$CINECA_SCRATCH/PPCON/DA_SATFLOAT/wrkdir
...
python plot_timeseries_STD.py -v chl -i $OUTDIR/Fig4.3/export_data_ScMYValidation_plan_open_sea_STD_CORR.pkl -o $OUTDIR/Fig4.2/
